...
public class AttendanceForm extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(374, 347));
        setMinimumSize(new java.awt.Dimension(374, 347));
        setResizable(false);
        ...
        jLabel5.setText("Attendance Form  ");
        ...
        try{
           conn=MySQLConnect.ConnectDb();
            ...
            if(jRadioButton1.isSelected()){
               attend=jRadioButton1.getText();
            }
            if(jRadioButton2.isSelected()){
               attend=jRadioButton2.getText(); 
            }
